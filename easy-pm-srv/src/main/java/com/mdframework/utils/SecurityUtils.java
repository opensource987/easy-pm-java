...
public class SecurityUtils
{
    ...
    public static String getUsername()
    {
        try
        {
            if(SecurityContextHolder.getContext() ==null || getAuthentication() == null){
                return "admin";
            }
     ...
     * 获取用户账户
     **/
    public static Boolean getIsTestUser()
    {
        try
        {
            ...
            getLoginUser();
            return getLoginUser().getUsername().equals("test");
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public static LoginUser getLoginUser()
    {
        try
        {
            Object o = getAuthentication();
            o = getAuthentication().getPrincipal();
