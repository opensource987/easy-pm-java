...
public interface SysMenuMapper extends BaseMapper<SysMenu>
{
    ...
    public List<SysMenu> selectMenuListByUserId(@Param("ew") QueryWrapper<SysMenu> lqw);
    ...
    public int updateMenu(@Param("ew") UpdateWrapper<SysMenu> lqw);
    ...
    List<SysMenu> listVo(@Param("ew") QueryWrapper<SysMenu> lqw);
}
