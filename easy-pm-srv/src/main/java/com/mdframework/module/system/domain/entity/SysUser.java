...
public class SysUser extends BaseEntity implements Serializable
{
    ...
    /** 用户关联项目模块 */
    @TableField(exist = false)
    private List<ProjectModuleVo> projectModules;
    ...
    private String wxcpDeptIds;
    private Long wxcpUserId;
...
//    private String dingtalkName;
    ...
    public String getWxcpDeptIds() {
        return wxcpDeptIds;
    }

    public void setWxcpDeptIds(String wxcpDeptIds) {
        this.wxcpDeptIds = wxcpDeptIds;
    }

    public Long getWxcpUserId() {
        return wxcpUserId;
    }

    public void setWxcpUserId(Long wxcpUserId) {
        this.wxcpUserId = wxcpUserId;
    }
