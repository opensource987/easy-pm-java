...
public class SysDept extends BaseEntity
{
    ...
    public Long getWxcpDeptId() {
        return wxcpDeptId;
    }

    public void setWxcpDeptId(Long wxcpDeptId) {
        this.wxcpDeptId = wxcpDeptId;
    }

    public Long getWxcpParentId() {
        return wxcpParentId;
    }

    public void setWxcpParentId(Long wxcpParentId) {
        this.wxcpParentId = wxcpParentId;
    }
