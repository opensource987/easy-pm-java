...
import com.mdframework.common.enums.BusinessStatus;
import com.mdframework.common.enums.HttpMethod;
...
import com.mdframework.common.utils.spring.SpringUtils;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.mdframework.common.annotation.Log)")
...
//            MemberInfo memberInfo = memberInfoService.getById(Integer.valueOf(memberId));
            ...
            if (e != null)
            {
                ...
                log.error("出现错误：===================");
                log.error("接口地址：" + operLog.getOperUrl());
                log.error("接口方法：" + operLog.getMethod());
                log.error("token：" + operLog.getOperName());
                log.error("请求参数：" + operLog.getOperParam());
                log.error("返回结果：" + operLog.getJsonResult());
                log.error("错误提示：" + StringUtils.substring(e.getMessage(), 0, 2000));
                log.error("========  end===========");
