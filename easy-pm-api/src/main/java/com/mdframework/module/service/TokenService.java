...
import com.mdframework.common.utils.ip.AddressUtils;
...
public class TokenService
{
     ...
     * @return 令牌
     */
    public String createToken(MemberInfo memberInfo)
    {
        Map<String, Object> claims = new HashMap<>();
        claims.put(Constants.LOGIN_USER_KEY, memberInfo.getId());
    ...
    public String getMemberId(String token)
    {
        ...
        return claims.get(Constants.LOGIN_USER_KEY).toString();
    }
