...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.mdframework.common.annotation.DataScope)")
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias)
    {
        ...
        if (StringUtils.isNotBlank(sqlString.toString()))
        {
            ...
            if (StringUtils.isNotNull(params) && params instanceof BaseEntity)
            {
                ...
                Object o = baseEntity.getParams();
                System.out.println("");
            }else if (StringUtils.isNotNull(params) && params instanceof QueryWrapper){
                QueryWrapper lqw = (QueryWrapper) params;
                //不关联部门的情况，仅查看当前用户数据
                if(deptAlias==null || deptAlias.equals("")){
                    lqw.apply(" (" + sqlString.substring(4) + ")");
                }
            }
        }
    }
