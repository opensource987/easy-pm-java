...
public class GenUtils
{
    ...
    public static void initColumnField(GenTableColumn column, GenTable table)
    {
        ...
        else if (arraysContains(GenConstants.COLUMNTYPE_NUMBER, dataType))
        {
            ...
            column.setHtmlType(GenConstants.HTML_DIGITINPUT);
        }
...
//        }
        ...
        // 状态字段设置单选框
        if (!"del_status".equals(columnName) && StringUtils.endsWithIgnoreCase(columnName, "status"))
        {
            column.setHtmlType(GenConstants.HTML_RADIO);
        }
        // 单件上传
        if (StringUtils.endsWithIgnoreCase(columnName, "pic"))
        {
            column.setHtmlType(GenConstants.HTML_UPLOAD);
        }
        // 多文件上传
        if (StringUtils.endsWithIgnoreCase(columnName, "pics"))
        {
            column.setHtmlType(GenConstants.HTML_MULTIPLE_UPLOAD);
        }
        // 类型&性别字段设置下拉框
