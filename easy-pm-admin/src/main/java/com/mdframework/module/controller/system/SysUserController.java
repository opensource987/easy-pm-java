...
import com.mdframework.module.system.service.ISysRoleService;
...
public class SysUserController extends BaseController
{
     ...
     * 获取用户列表
     */
    @PreAuthorize("@ss.hasPermi('project:crew:list')")
    @GetMapping("/listWithProjects")
    public TableDataInfo listWithProjects(SysUser user)
    {
        startPage();
        List<SysUser> list = userService.selectUserProjectList(user);
        return getDataTable(list);
    }
    ...
    public Map getInfo(@PathVariable(value = "userId", required = false) Long userId)
    {
