...
import com.mdframework.module.system.domain.req.SysConfigReq;
...
public class SysConfigController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<SysConfigVo> list(SysConfigReq sysConfigReq)
    {
        startPage();
        QueryWrapper<SysConfig> lqw = new QueryWrapper<SysConfig>();
        sysConfigReq.generatorQuery(lqw);
        List<SysConfigVo> list = configService.listVo(lqw);
    ...
    {
        QueryWrapper<SysConfig> lqw = new QueryWrapper<SysConfig>();
        List<SysConfig> list = configService.selectMPConfigList(lqw);
