...
import com.mdframework.module.system.domain.req.SysPostReq;
...
public class SysPostController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<SysPost> list(SysPostReq sysPostReq)
    {
        startPage();
        QueryWrapper<SysPost> lqw = new QueryWrapper<SysPost>();
        sysPostReq.generatorQuery(lqw);
        List<SysPostVo> list = postService.listVo(lqw);
