...
import com.mdframework.module.system.domain.req.SysDictTypeReq;
...
public class SysDictTypeController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<SysDictTypeVo> list(SysDictTypeReq sysDictTypeReq)
    {
        startPage();
        QueryWrapper<SysDictType> lqw = new QueryWrapper<>();
        sysDictTypeReq.generatorQuery(lqw);
        List<SysDictTypeVo> list = dictTypeService.listVo(lqw);
    ...
    @GetMapping("/export")
    public AjaxResult export(SysDictTypeReq sysDictTypeReq)
    {
        QueryWrapper<SysDictType> lqw = new QueryWrapper<>();
        sysDictTypeReq.generatorQuery(lqw);
        List<SysDictTypeVo> list = dictTypeService.listVo(lqw);
