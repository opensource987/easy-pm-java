...
import com.mdframework.module.system.domain.req.SysNoticeReq;
...
public class SysNoticeController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<SysNoticeVo> list(SysNoticeReq sysNoticeReq)
    {
        startPage();
        QueryWrapper<SysNotice> lqw = new QueryWrapper<SysNotice>();
        sysNoticeReq.generatorQuery(lqw);
        //List<SysNotice> list = noticeService.selectNoticeList(notice);
        List<SysNoticeVo> list = noticeService.listVo(lqw);
