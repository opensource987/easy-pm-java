...
import com.mdframework.module.system.domain.req.SysRoleReq;
import com.mdframework.module.system.domain.vo.SysRoleVo;
...
public class SysRoleController extends BaseController
{
    ...
    @GetMapping("/list")
    public TableDataInfo<SysRoleVo> list(SysRoleReq sysRoleReq)
    {
        startPage();
        QueryWrapper<SysRole> lqw = new QueryWrapper<>();
        sysRoleReq.generatorQuery(lqw);
        List<SysRoleVo> list = roleService.listVo(lqw);
